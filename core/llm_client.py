    ...
    def load_model(self):
        with self._lock:
            ...
            try:
                ...
                # Limitar hilos para evitar violaciones de acceso (0xC0000005) en Windows x86_64
                ...
                logger.info("Local CPU LLM TinyLlama-1.1B loaded successfully (context=%d, threads=%d).", self._context_length, threads)
                return self._model
            except Exception as exc:
