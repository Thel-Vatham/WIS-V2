...
public class Audio {
  public static IAudioEndpointVolume GetAev() {
  ...
  public static float GetVolume() { float v; GetAev().GetMasterVolumeLevelScalar(out v); return v * 100f; }
  public static bool GetMute() { bool m; GetAev().GetMute(out m); return m; }
  public static void SetVolume(float pct) { GetAev().SetMasterVolumeLevelScalar(pct/100f, Guid.Empty); }
  public static void SetMute(bool m) { GetAev().SetMute(m, Guid.Empty); }
}
'@
